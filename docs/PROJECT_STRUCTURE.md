...
* EfficientNetB0
* EfficientNetB0 — selected/shared backbone, code identifier `efficientnetb0_se`
+   (same architecture as the baseline; the identifier is retained for
+   compatibility and does not represent a distinct network)
* MobileNetV3
